...
CREATE TABLE users IF NOT EXISTS(user_id SERIAL PRIMARY KEY, user_name TEXT NOT NULL);
CREATE TABLE tasks IF NOT EXISTS(task_id SERIAL PRIMARY KEY, user_id TEXT NOT NULL, name TEXT NOT NULL, due_date TEXT NOT NULL,
